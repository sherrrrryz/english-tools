          ...
          {filteredHighlights.length > 0 ? (
              ...
              <div key={highlight.id} className="relative group">
                ...
                <div className="absolute top-0 right-0 p-2 flex space-x-1">
                  <button
                    ...
                    title={highlight.isLearned ? "Learned" : "Mark as learned"}
                  >
                  ...
                  <button
                    ...
                    title={highlight.isFavorite ? "Favorited" : "Add to favorites"}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="col-span-full card p-12 text-center">
              ...
              <p className="text-gray-500 text-lg">
                {searchQuery ? 'No matching words found' : 'No words yet, add highlights on the reading page'}
              </p>
            </div>
          )}
        </div>
